...
class Kacheries extends Admin_controller  {

	private $table = 'kacheries';
	protected $redirect = 'kacheries';
	protected $title = 'Kacheri';
	protected $name = 'kacheries';
    ...
    {
        check_ajax();
        $this->load->model('kacheries_model', 'data');
	...
	public function update($id)
	{
        ...
        if ($this->form_validation->run() == FALSE)
        {
            ...
            $data['url'] = $this->redirect;
            $data['data'] = $this->main->get($this->table, 'name, slug, mobile, email, address', ['id' => d_id($id)]);
    ...
    protected $validate = [
        ...
        [
            ...
            'errors' => [
                'required' => "%s is required",
                'max_length' => "Exact 100 chars required.",
            ],
        ],
        [
            'field' => 'address',
            ...
            'errors' => [
                'required' => "%s is required",
                'max_length' => "Exact 255 chars required.",
            ],
        ]
    ];
}