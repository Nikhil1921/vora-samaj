...
class Information extends Admin_controller  {
	...
	{
		parent::__construct();
		$this->path = $this->config->item('information');
	}

	private $table = 'information';
	protected $redirect = 'information';
	...
	public function get()
    {
        ...
        {  
            ...
            $action .= '<a href="'.base_url($this->path.$row->image).'" class="dropdown-item" target="_blank"><i class="fa fa-eye"></i> View</a>';
    ...
    protected $validate = [
        [
            ...
            'errors' => [
                ...
                'max_length' => "Max 250 chars allowed.",
            ],
        ],
        [
            'field' => 'description',
