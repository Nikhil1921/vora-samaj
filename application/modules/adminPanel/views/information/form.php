        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor" required name="description" id="description" cols="30" rows="10"><?= set_value('description') ? set_value('description') : (isset($data['description']) ? $data['description'] : '') ?></textarea>
